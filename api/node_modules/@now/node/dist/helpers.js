...
function getBodyParser(req, body) {
    return function parseBody() {
        ...
        const { parse: parseContentType } = __webpack_require__(217);
...
function getCookieParser(req) {
    return function parseCookie() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        const { parse } = __webpack_require__(640);
...
function setCharset(type, charset) {
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    const { parse, format } = __webpack_require__(217);
...
function createETag(body, encoding) {
    // eslint-disable-next-line @typescript-eslint/no-var-requires
    const etag = __webpack_require__(266);
